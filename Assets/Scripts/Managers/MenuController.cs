...
public class MenuController : MonoBehaviour
{
    ...
    [SerializeField] private Button[] brokenButtons; // 0 = Dif�cil, 1 = Normal
    [SerializeField] private Button goodButton;      // Bot�n del nivel bueno
    [SerializeField] private Button optionsButton;   // Bot�n de Opciones
    [SerializeField] private GameObject optionsMenuCanvas; // Canvas del men� de opciones
    ...
    private void Start()
    {
        ...
        // Mostrar solo el bot�n Dif�cil al inicio
    ...
    {
        if (scene.buildIndex == 0) // Men�
        {
            if (mainMenuCanvas != null)
                mainMenuCanvas.SetActive(true);

            if (optionsMenuCanvas != null)
                optionsMenuCanvas.SetActive(false); // Ocultar opciones al entrar al men�
    ...
    private void PlayMenuMusic()
    {
        ...
        {
            Debug.Log("Reproduciendo m�sica de men�: " + menuMusic.name);
    ...
    public void OpenOptionsMenu()
    {
        ...
        if (optionsMenuCanvas != null)
        {
            ...
            // Resetear paneles siempre que se abra el men�
